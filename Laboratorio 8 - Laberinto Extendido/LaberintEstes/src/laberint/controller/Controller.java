...
public class Controller {
    ...
    /**
     * LabEstes: Crea el laberint i retorna l'habitació on estarà inicialment
     * l'aventurer.
     * 
    ...
    public Room createDungeon() {
        ...
        this.createRoom("Caverna Principal",
                "Una enorme caverna s'obre al teu davant. Terra i sostre es troben plens d'estalagmites i estalactites. Es un cofre això que es veu?");
        this.createRoom("Cul de sac",
                "El passadís acaba abruptament en un munt de rocs producte d'una esllevissada. Sembla que hi ha un forat.");
    ...
    /**
     * L'aventurer deixa l'item indicat a la sala actual i retorna el codi d'èxit o
     * error.
     * 
    ...
    /**
     * LabEstes: L'aventurer utilitza l'item indicat com a clau per activar
     * l'element indicat.
     * 
     ...
     * @param value
     * @param encumbrance
     * @param where,      nom de la sala on es deixa l'item. Si
     *                    (where.isEmpty()==true)
     *                    l'item no es deixa a cap sala (només s'afegeix al map de
     *                    allItems).
     */
    ...
    /**
     * LabEstes: Crea una porta secreta name entre les sales origin i destination,
     * activada per key.
     * 
     * @param name
     * @param key
    ...
    /**
     * LabEstes: Crea un contenidor secret name a la sala where activat per key que
     * conté
     * un hiddenItem.
     * 
     * @param name
