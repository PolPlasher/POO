...
public class Controller {
    ...
    public Room createDungeon() throws LaberintException {
        ...
        this.createRoom("Caverna Principal",
                "Una enorme caverna s'obre al teu davant. Terra i sostre es troben plens d'estalagmites i estalactites.");
     ...
     *                    allItems).
     *                    Si la Room where no existeix, llença una LaberintException
     *                    amb el
    ...
    public void createItem(String name, String description, int value, int encumbrance, String where)
        ...
        if (!where.isEmpty()) {
            ...
            if (null == here)
                throw new LaberintException("No such room");
     ...
     * @param destination
     * @param accesName
     *                    Si alguna de les dos sales no existeix, llença una
     *                    LaberintException amb el
     *                    missatge "No such room".
     */
